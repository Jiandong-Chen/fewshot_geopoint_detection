...
def convert_coordinates(image_path, annotation_path, output_path):
    with open(annotation_path, 'r') as coordinates_file:
...
# Example usage
cropped_patches = '/Users/dong_dong_dong/Downloads/Darpa/val/val_bbox/images'
annotation = '/Users/dong_dong_dong/Downloads/Darpa/val/val_bbox/annotation'
output_path = '/Users/dong_dong_dong/Downloads/Darpa/fewshot/datasets/ta1/labels/val'
